...
const PrivacyScreen = ({ navigation }) => {
      ...
      [
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: () => {
            Alert.alert(
              "Éxito",
              "Tu solicitud ha sido procesada. Revisa tu email en los próximos minutos."
            );
          },
        },
      ]
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* Security Score - VISIBILIDAD MEJORADA */}
          ...
          <Card.Content style={styles.scoreContent}>
            ...
            <View style={styles.scoreInfo}>
              ...
              <Text style={styles.scoreDescription}>
                Tu cuenta está bien protegida. Considera activar la
        ...
        <Card style={styles.card}>
          ...
          >
            ...
            <View style={styles.dangerContent}>
              <Text style={styles.dangerLabel}>Descargar mis datos</Text>
        ...
        {/* Privacy Policy - VISIBILIDAD MEJORADA */}
        <Card style={styles.policyCard}>
          <Card.Content style={styles.policyContent}>
            ...
            <View style={styles.policyText}>
              <Text style={styles.policyTitle}>Política de Privacidad</Text>
              <Text style={styles.policyDescription}>
                Lee nuestra política completa para entender cómo protegemos tus
                datos
              </Text>
            </View>
          </Card.Content>
      ...
      <Portal>
        ...
        <Modal
          ...
          onDismiss={() => setDevicesVisible(false)}
          contentContainerStyle={styles.modalContent}
        >
          <Card
            style={[
          ...
          >
            ...
            <Card.Content style={styles.modalBody}>
                ...
                <View key={device.id}>
                  <View style={styles.deviceItem}>
                    ...
                    <View style={styles.deviceInfo}>
                      ...
                      <Text style={styles.deviceDetail}>
                        Último acceso: {device.lastAccess}
                      </Text>
                    </View>
                  </View>
              ...
              <Button
                mode="outlined"
                onPress={() => setDevicesVisible(false)}
                style={{ marginTop: 16 }}
              >
                Cerrar
              </Button>
                  ...
                  <View style={styles.historyItem}>
                    ...
                    >
                      <FontAwesome
                        ...
                        size={18}
                        color={
                          item.status === "success" ? "#10B981" : "#F44336"
                        }
                      />
                    </View>
...
const createStyles = (theme) =>
  StyleSheet.create({
    ...
    // --- ESTILO CORREGIDO PARA PUNTUACIÓN ---
    scoreCard: {
    ...
    scoreDescription: {
      fontSize: 12,
      color: theme.colors.text, // Cambiado de disabled a text
      opacity: 0.8, // Opacidad para jerarquía visual pero legible
      lineHeight: 18,
    },
    // ----------------------------------------
    sectionTitle: {
    ...
    // --- ESTILO CORREGIDO PARA POLÍTICAS ---
    policyCard: {
      backgroundColor: theme.colors.surface, // Fondo sólido
      marginBottom: 20,
      elevation: 2,
